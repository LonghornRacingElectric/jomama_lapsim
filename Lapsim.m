...
%% Section 0: Name all symbolic variables (GARBAGE SECTION)
...
%% Section 13: Acceleration Analysis
...
%% Section 14: Generate scores & export data
...
Total_Points = Accel_Score+Skidpad_Score+Endurance_Score;

results = [time_elapsed' velocity'];
%xlswrite('logged_data.xlsx',results,'sim_data') 

%% Section 15: Plot Results
